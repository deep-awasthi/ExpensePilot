...
public class UpdateTransactionCommand {
    ...
    public UpdateTransactionCommand(UUID userId, TransactionType type, Category category, BigDecimal amount, String description, Instant transactionDate) {
        this.userId = userId;
        this.type = type;
    ...
    public static class Builder {
        ...
        public UpdateTransactionCommand build() {
            return new UpdateTransactionCommand(userId, type, category, amount, description, transactionDate);
        }
    }
}
